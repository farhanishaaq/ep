@extends('diagonostic_procedures.layouts.master')
<!--========================================================
                          TITLE
=========================================================-->
@section('title')
...
@section('content2')
	   ...
	   <center>
            ...
            {{ Form::model($diagonosticprocedure, ['route' => ['diagonostic_procedures', $diagonosticprocedure->id], 'method' => 'put' ,'style' => 'padding: 40px', 'id' => 'regForm'])}}
