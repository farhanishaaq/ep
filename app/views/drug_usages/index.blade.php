@extends('drug_usages.layouts.master')
<!--========================================================
                          TITLE
=========================================================-->
@section('title')
...
@section('content2')
    <section id="content">
        ...
        @if(Auth::user()->role != 'Doctor') 
            <center>{{ link_to_route('drug_usages', 'Add Drug Usage', ['id' => $patient->id], ['class' => 'btn_1'])}}</center>
            		<br>
        @endif
                ...
                @if(($drugUsages) != null)
                    @foreach($drugUsages as $drugusage)
                        <tr>
                            ...
                            <td>
                            {{ link_to_route('drug_usages', 'View', [$drugusage->id], ['class' => 'data_table_btn', 'style' => 'margin-bottom: 2px'])}}
                        @if(Auth::user()->role != 'Doctor') 
