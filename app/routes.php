...
//Route::post('doLogin', 'EmployeesController@doLogin');
...
Route::post('doLogin', array('as'=>'doLogin','uses'=>'EmployeesController@doLogin'));
...
//        Route::get('/admin_home', 'HomeController@showAdmin_home');
        Route::get('adminHome', array('as'=>'adminHome','uses'=>'HomeController@showAdmin_home'));
...
//    Route::any('/doctor_home', array('before' => 'Doctor', 'uses' => 'HomeController@showDoctor_home'));
    Route::any('doctorHome', array('before' => 'Doctor', 'as'=>'doctorHome', 'uses' => 'HomeController@showDoctor_home'));
...
//    Route::get('/labmanager_home', array('before' => 'Lab', 'uses' => 'HomeController@showLabmanager_home'));
    Route::get('labManagerHome', array('before' => 'Lab', 'as'=>'labManagerHome', 'uses' => 'HomeController@showLabmanager_home'));
...
//    Route::get('/accountant_home', array('before' => 'Accountant', 'uses' => 'HomeController@showAccountant_home'));
    Route::get('accountantHome', array('before' => 'Accountant','as' => 'accountantHome', 'uses' => 'HomeController@showAccountant_home'));
