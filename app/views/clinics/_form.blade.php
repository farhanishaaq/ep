<section class="form-Section col-md-6 h400 fL">
    <div class="container w100p">
        ...
        <div class="form-group">
            <label class="col-xs-5 control-label asterisk">Admin Name</label>
            <div class="col-xs-6">
                <input type="text" id="name" name="name" required="true" value="{{{ isset($admin)? $admin->name : '' }}}" class="form-control" placeholder="name">
                <span id="errorName" class="field-validation-msg"></span>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <input type="password" id="password" name="password" required="true" class="form-control" placeholder="password">
                <span id="errorPassword" class="field-validation-msg"></span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-xs-5 control-label asterisk">Re-type Password</label>
            <div class="col-xs-6">
                <input type="password" id="name" name="confirm_password" required="true" class="form-control" placeholder="password">
                <span id="errorName" class="field-validation-msg"></span>
            </div>
        </div>
        @endif
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <input type="email" id="email" name="email" required="true" value="{{{ isset($admin)? $admin->email : '' }}}" class="form-control" placeholder="email">
                <span id="errorEmail" class="field-validation-msg"></span>
            </div>
        </div>  
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <label class="switch switch-green">
                    <input type="checkbox" required="true" class="switch-input" name="gender" id="gender_0">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <input type="number" id="age" name="age" required="true" value="{{{ isset($admin)? $admin->age : ''  }}}" class="form-control" placeholder="age">
                <span id="errorAge" class="field-validation-msg"></span>
            </div>
        </div>
    </div>
</section>
<section class="form-Section col-md-6 h400 fL">
    <div class="container w100p">
        ...
        <hr class="w95p fL mT0" />
        <div class="form-group">
            <label class="col-xs-5 control-label asterisk">Admin City</label>
            <div class="col-xs-6">
                <input type="text" id="city" name="city" required="true" value="{{{ isset($admin)? $admin->city : ''  }}}" class="form-control" placeholder="city">
                <span id="errorAge" class="field-validation-msg"></span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-xs-5 control-label asterisk">Admin Country</label>
            <div class="col-xs-6">
                ...
                <span id="errorCountry" class="field-validation-msg"></span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-xs-5 control-label asterisk">Admin Address</label>
            <div class="col-xs-6">
                <input type="text" id="address" name="address" required="true" value="{{{ isset($admin)? $admin->address : ''  }}}" class="form-control" placeholder="city">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <input type="tel" id="phone" name="phone" required="true" value="{{{ isset($admin)? $admin->phone : ''  }}}" class="form-control" placeholder="(0092)333-1234567">
                <span id="errorAddress" class="field-validation-msg"></span>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <input type="text" id="cnic" name="cnic" required="true" value="{{{ isset($admin)? $admin->cnic : ''  }}}" class="form-control" placeholder="cnic">
                <span id="errorAddress" class="field-validation-msg"></span>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <textarea type="text" id="note" name="note" rows="7" cols="20" class="form-control" placeholder="note">{{{ Form::getValueAttribute('checkup_reason', null) }}}</textarea>
