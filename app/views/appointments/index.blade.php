            ...
            <tbody>
                ...
                <tr class="row-data">
                    ...
                    <td>
                        ...
                        <span class="fL">&nbsp;|&nbsp;</span><a href="javascript:void(0)" class="btn-edit-disable-icon fL" title="Edit Record not allowed"></a>
                        @endif
                        <span class="fL">&nbsp;|&nbsp;</span><a href="{{route('prescriptions.create')}}?id={{$appointment->id}}" class="btn-view-icon fL" ></a>
                        <span class="fL">&nbsp;|&nbsp;</span><a href="{{route('prescriptions.index',['id' => $appointment->patient->id])}}" class="btn-view-icon fL" title="View Previous Prescriptions"></a>
                    </td>
                </tr>
                @endforeach
                @else
