...
@section('content')
    ...
    <form action="{{route('articleupdate')}}" method="post" enctype="multipart/form-data" style="padding-left: 60px; padding-right: 60px">
        ...
        <input required="required"  placeholder="Enter title here" value="{{$articles->title}}" type="text" name = "title"class="form-control" />
        {{--</div>--}}
        <div class="form-group">
            <textarea name='body'class="form-control"  style="min-height: 300px"  >{{$articles->article_text}}</textarea>
        </div>
