...
@section('content')
    <div class="container mT20">
        ...
        {{--@endif--}}
        {{--
        <button class="mT10 mB0 c3" style="font-family: 'Marvel'; float: right;">
            ...
            <table id="tblRecordsList" class="mT20 table table-hover table-striped display noShow">
                ...
                @foreach($articlestatus as $data)
                    ...
                    <tr>
                        ...
                        <td><a type="button" class="btn btn-raised btn-sm btn-1" href="{{url('articlesedit/'.$data->id)}}" name="update">UPDATE</a>
                            <a type="button" class="btn btn-raised btn-sm btn-1" href="{{url('articles/'.$data->id)}}" name="update">View</a></td>
