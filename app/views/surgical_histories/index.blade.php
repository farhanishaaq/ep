@extends('surgical_histories.layouts.master')
<!--========================================================
                          TITLE
=========================================================-->
@section('title')
...
@section('content2')
    <section id="content">
        ...
        @if(Auth::user()->role != 'Doctor') 
            <center>{{ link_to_route('surgical_histories', 'Create Surgical History', ['id' => $patient->id], ['class' => 'btn_1'])}}</center>
            		<br>
        @endif
                ...
                @if(($surgicalhistories) != null)
                    @foreach($surgicalhistories as $surgicalhistory)
                        ...
                        @if(Auth::user()->role != 'Doctor') 
                            {{ link_to_route('surgical_histories', 'Edit', [$surgicalhistory->id], ['class' => 'data_table_btn'])}}
                        @endif
                            </td>
                        </tr>
                    @endforeach
