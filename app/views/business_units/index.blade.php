...
@section('content')
 <div class="container mT20">
     <h1 class="mT10 mB0 c3" style="font-family: 'Marvel'">Business Units List</h1>
     <hr class="w100p fL mT0" />
		<!--========================================================
                                     Data Table
        =========================================================-->
    <section id="form-Section">
         {{ link_to_route('businessUnits.create', 'Register Business Unit', '', ['class' => 'btn_1'])}}
                     ...
                     @foreach($companies as $company)
                          <tr class="row-data">
                             ...
                             <td>{{ $company->address }}</td>
                              <td>
                                  {{ link_to_route('businessUnits.show', '', [$company->id], ['class' => 'btn-view-icon fL', 'title'=> 'View Record'])}}
                                  <span class="fL">&nbsp;|&nbsp;</span> {{ link_to_route('businessUnits.edit', '', [$company->id], ['class' => 'btn-edit-icon fL','title'=> 'Edit Record'])}}
                              </td>
                          </tr>
                      @endforeach
                 @else
