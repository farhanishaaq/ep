...
<div id="detail-row-0" class="form-group list-group h170" data-row-index="0">
    <div class="col-xs-12">
        ...
        <a href="javascript:void(0)" class="col-xs-12 p5 list-group-item list-group-item-action h150">
            ...
            <div class="form-group col-xs-3 pR2 mB3">
                <div class="col-xs-12 prescription-qty-unit-css">
                    <input type="text" id="quantity" name="strength_quantity[0]" class="form-control col-xs-3" value="" placeholder="Qty">
            ...
            <div class="form-group col-xs-4 pR2 mB3">
                <div class="col-xs-12 frequencies-multi-slct">
                    <input type="hidden" id="frequencies" name="frequencies[0]" class="form-control col-xs-3" value="">
                    {{frequency_drop_down()}}
                    <span id="errorName" class="field-validation-msg"></span>
                </div>
            </div>
